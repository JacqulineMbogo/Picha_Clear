...
public class Lenses_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>   {

    private Context mContext;
    private List<Lenses_Model> mLensesModelList;

    private String TAG ="Lenses_adapter";
    private int mScrenwith;


    public Lenses_Adapter(Context context, List<Lenses_Model> list, int screenwidth ){
        mContext = context;
        mLensesModelList = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        final Lenses_Model model = mLensesModelList.get(position);
        ...
        ((DuckProductHolder) holder).cardView.setOnClickListener(new View.OnClickListener() {
            @Override
